...
if ( ! class_exists( 'Kirki_Controls_Number_Control' ) ) {
	...
	class Kirki_Controls_Number_Control extends Kirki_Customize_Control {
		...
		public function enqueue() {
			Kirki_Styles_Customizer::enqueue_customizer_control_script( 'jquery-ui-spinner', 'vendor/jquery-ui-spinner', array(
				'jquery',
				'jquery-ui-core',
				'jquery-ui-button'
			) );
			Kirki_Styles_Customizer::enqueue_customizer_control_script( 'kirki-number', 'controls/number', array(
				'jquery',
				'formstone',
				'formstone-number'
			) );
